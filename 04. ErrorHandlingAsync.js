 ...
 * 3. Asks the user for their contact information.
 * 4. Validates phone numbers and email addresses.
 * 5. Saves the collected data into `contacts.json` in a structured format.
 * 6. Displays a success message upon saving the contact information.
 *
 * Features:
 * - Ensures persistent storage of contacts.
 * - Uses Promises and async/await for better readability and control flow.
